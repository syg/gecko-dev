...
class JS_FRIEND_API(ReadOnlyCompileOptions) : public TransitiveCompileOptions
{
  ...
  public:
    ...
    // Only applicable to non-function scripts.
...
class JS_FRIEND_API(OwningCompileOptions) : public ReadOnlyCompileOptions
{
  ...
  public:
    ...
    OwningCompileOptions& setHasNonSyntacticScope(bool ns) { hasNonSyntacticScope = ns; return *this; }
...
class MOZ_STACK_CLASS JS_FRIEND_API(CompileOptions) : public ReadOnlyCompileOptions
{
  ...
  public:
    ...
    CompileOptions& setHasNonSyntacticScope(bool ns) { hasNonSyntacticScope = ns; return *this; }
