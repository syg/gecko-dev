            ...
            switch (bi.kind()) {
              case BindingKind::Let: {
                  ...
                  if (!annexB35Allowance) {
                      bool isCatch = si.kind() == ScopeKind::SimpleCatch ||
                                     si.kind() == ScopeKind::Catch;
                      return Some(isCatch ? DeclarationKind::CatchParameter : DeclarationKind::Let);
                  }
                  break;
              }
